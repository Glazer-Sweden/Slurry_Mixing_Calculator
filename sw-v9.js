/*
  ...
  IMPORTANT:
  - This file must be named sw-v01.js
  - CACHE_NAME must match the version number
  - index.html must register this file:
        navigator.serviceWorker.register("/Slurry_Mixing_Calculator/sw-v01.js");

  When you release Version 10:
  - Duplicate this file as sw-v10.js
  - Update CACHE_NAME to "Slurry_Mixing_Calculator-cache-v10"
  - Update index.html to register sw-v10.js
*/

// Expose version to the client
const APP_VERSION = "01";

const CACHE_NAME = "Slurry_Mixing_Calculator-cache-v01";
